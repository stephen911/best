...
<!-- Mirrored from learnplus.demo.frontendmatter.com/guest-forgot-password.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 May 2022 13:24:33 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <div class="d-flex align-items-center"
            ...
            <div class="col-sm-8 col-md-6 col-lg-4 mx-auto"
                ...
                <div class="card navbar-shadow">
                    ...
                    <div class="card-footer text-center text-black-50">Remember your password? <a href="index.php">Login</a></div>
                </div>
            </div>
        </div>
