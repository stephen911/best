                            ...
                            ?>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="list-group-item">
                                            ...
                                            <div class="list-group-item" id="Greater Accra" style="display: none;">
                                            <div class="form-group m-0" role="group"
...
<option value="WEIJA GBAWE MUNICIPAL">WEIJA GBAWE MUNICIPAL</option>
                                        ...
                                        <div class="list-group-item" id="Ahafo Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="TANO SOUTH MUNICIPAL">TANO SOUTH MUNICIPAL</option>
                                        ...
                                        <div class="list-group-item" id="Bono East Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="TECHIMAN NORTH DISTRICT">TECHIMAN NORTH DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Ashanti Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="SUAME MUNICIPAL">SUAME MUNICIPAL</option>
                                        ...
                                        <div class="list-group-item" id="Central Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="UPPER DENKYIRA WEST DISTRICT">UPPER DENKYIRA WEST DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Bono Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="WENCHI MUNICIPAL">WENCHI MUNICIPAL</option>
                                        ...
                                        <div class="list-group-item" id="North East Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="YUNYOO-NASUAN DISTRICT">YUNYOO-NASUAN DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Northern Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="ZABZUGU DISTRICT">ZABZUGU DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Eastern Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="YILO KROBO MUNICIPAL">YILO KROBO MUNICIPAL</option>
                                        ...
                                        <div class="list-group-item" id="Oti Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="NKWANTA SOUTH DISTRICT">NKWANTA SOUTH DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Upper East Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="TEMPANE DISTRICT">TEMPANE DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Savannah Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="WEST GONJA DISTRICT">WEST GONJA DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Volta Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="SOUTH TONGU DISTRICT">SOUTH TONGU DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Upper West Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="WA WEST DISTRICT">WA WEST DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Western North Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
...
<option value="SUAMAN DISTRICT">SUAMAN DISTRICT</option>
                                        ...
                                        <div class="list-group-item" id="Western Region" style="display: none;">
                                            <div class="form-group m-0" role="group"
                                                aria-labelledby="label-highestEduLevel">
                                                <div class="form-row">
                                                    <label id="label-highestEduLevel" for="highestEduLevel"
