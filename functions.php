...
function updateuser($id, $title, $name, $gender, $email, $contact, $telegram, $lincesed, $nameofschool, $region, $district, $foodpref, $heard, $tdate)
{
    ...
    if ($up) {
        ...
        var_dump($send->sms('TUCEE HUB', $contact, 'Congratulations, you are duly registered for the counselling training. Proceed to make payment to comfirm your participation.  for any assistance.  Thanks'));
