...
<head>
    <title>iCounsel Gh - Dashboard</title>
                                                ...
                                                <div class="card bg-c-yellow update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php totalusers();?></h4>
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i
                                                                class="feather icon-clock text-white f-14 m-r-10"></i>total users in records</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-green update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php totaladdmins();?></h4>
                                                                <h6 class="text-white m-b-0">Total Admins</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i
                                                                class="feather icon-clock text-white f-14 m-r-10"></i>All the admins</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-pink update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php totalbookings();?></h4>
                                                                <h6 class="text-white m-b-0">Total bookings</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i
                                                                class="feather icon-clock text-white f-14 m-r-10"></i>Total bookings in database</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-lite-green update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php totaltupsu();?></h4>
                                                                <h6 class="text-white m-b-0">Total tupsu</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i
                                                                class="feather icon-clock text-white f-14 m-r-10"></i>Total tupsu in records</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-green update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php totalcounsellors();?></h4>
                                                                <h6 class="text-white m-b-0">Total Counsellors</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <canvas id="update-chart-2" height="50"></canvas>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-yellow update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php approvedbk();?></h4>
                                                                <h6 class="text-white m-b-0">Approved Bookings</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <canvas id="update-chart-1" height="50"></canvas>
                                                            </div>
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i
                                                                class="feather icon-clock text-white f-14 m-r-10"></i>total approved  bookings</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-green update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?php pendingbk();?></h4>
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i
                                                                class="feather icon-clock text-white f-14 m-r-10"></i>All pending bookings</p>
                                                    </div>
                                                </div>
                                            </div>
...
<![endif]-->
    ...
    <!-- Chart js -->
    <script type="text/javascript" src="https://demo.dashboardpack.com/adminty-html/files/bower_components/chart.js/dist/Chart.js"></script>
    <!-- amchart js -->
    <script src="https://demo.dashboardpack.com/adminty-html/files/assets/pages/widget/amchart/amcharts.js"></script>
    <script src="https://demo.dashboardpack.com/adminty-html/files/assets/pages/widget/amchart/serial.js"></script>
    <script src="https://demo.dashboardpack.com/adminty-html/files/assets/pages/widget/amchart/light.js"></script>
    <script src="https://demo.dashboardpack.com/adminty-html/files/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script type="text/javascript" src="https://demo.dashboardpack.com/adminty-html/files/assets/js/SmoothScroll.js"></script>
    ...
    <script type="text/javascript" src="https://demo.dashboardpack.com/adminty-html/files/assets/pages/dashboard/custom-dashboard.js"></script>
    <script type="text/javascript" src="https://demo.dashboardpack.com/adminty-html/files/assets/js/script.min.js"></script>
