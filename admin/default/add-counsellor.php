                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <center><h5>Add New Counsellor</h5></center>
                                                        <!-- <span>lorem ipsum dolor sit amet, consectetur adipisicing -->
                                                            <!-- elit</span> -->
                                                                ...
                                                                <div class="j-content">
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <label class="j-input j-select">
                                                                            <select name="cgroup">
                                                                                <option value="" selected>Choose Counsellor's group
                                                                                    </option>
                                                                               
                                                                                <option value="Child and Adolescent">Child and Adolescent</option>
                                                                                <option value="Religious">Religious</option>
                                                                                <option value="School">School</option>
                                                                                <option value="Adult and Aged">Adult and Aged</option>
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <label class="j-input j-select">
                                                                            <select name="region">
                                                                                <option value="" selected>Choose Counsellor's Region
                                                                                    </option>
                                                                     ...
                                                                     <div class="j-unit">
                                                                        <label class="j-input j-select">
                                                                            <select name="type">
                                                                                ...
                                                                                <option value="Regenerative Health">Regenerative Health</option>
                                                                                <option value="Behaviour Modifications">Behaviour Modifications</option>
                                                                                <option value="Crisis and Bereavement">Crisis and Bereavement</option>
                                                                                <option value="Addiction">Addiction</option>
                                                                                <option value="Financial">Financial</option>
                                                                                <option value="Reproductive Health ">Reproductive Health</option>
                                                                                <option value="Sexuality Crisis">Sexuality Crisis</option>
                                                                            </select>
                                                                            <i></i>
                                                                        </label>
                                                                    </div>
                                                                    <!-- end country -->
                                                                     ...
                                                                     <div class="j-unit">
                                                                        <label class="j-input j-select">
                                                                            <select name="type2">
                                                                                <option value="" selected>Choose  Another Counsellor type
                                                                                    </option>
                                                                                <option value="Academic and Career">Academic and Career</option>
                                                                                <option value="Relationship and Marriage">Relationship and Marriage</option>
                                                                                <option value="Regenerative Health">Regenerative Health</option>
