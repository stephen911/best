                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <center><h5>Assign Token To  Customer</h5></center>
                                                        <!-- <span>lorem ipsum dolor sit amet, consectetur adipisicing -->
                                                            <!-- elit</span> -->
                                                        <?php 
                                                        include 'db.php';
                                                        ...
                                                        $get = mysqli_query($conn,"SELECT * FROM ptest WHERE id ='$bid'");
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form class="j-pro adisc" id="j-pro">
                                                                <!-- end /.header-->
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <!-- <div class="j-row">
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <div class="j-input">
                                                                            ...
                                                                            <input type="text" id="phone"
                                                                                name="b" placeholder="Counsellor Location" value="<?php echo 'Request No: #'.$bid;?>" readonly>

                                                                                <input type="hidden" id="phone" name="pid" placeholder="request no" value="<?php echo $bid;?>">
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <div class="j-input">
                                                                            ...
                                                                            <input type="text" id="phone"
                                                                                name="name" placeholder="idiscover-me token" value="<?php echo $_GET['name'];?>" readonly>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <div class="j-input">
                                                                            ...
                                                                            <input type="text" id="phone"
                                                                                name="token" placeholder="idiscover-me token" value="">
                                                                        </div>
                                                                    </div>
                                                                    <!-- end subject -->
                                                                     ...
                                                                     <!-- <div class="j-unit">
                                                                        <label class="j-input j-select">
                                                                            <select name="type">
                                                                                <option value="" selected>Choose Counsellor type
                                                                                    </option>
                                                                                <option value="Academic and Career counsellor">Academic and Career</option>
                                                                                <option value="Relationship and Marriage counsellor">Relationship and Marriage</option>
                                                                                <option value="Regenerative Health counsellor">Regenerative Health</option>
                                                                                <option value="Behaviour Modifications counsellor">Behaviour Modifications</option>
                                                                                <option value="Crisis and Bereavement counsellor">Crisis and Bereavement</option>
                                                                                <option value="Addiction counsellor">Addiction</option>
                                                                                <option value="Financial counsellor">Financial</option>
                                                                                <option value="Reproductive Health counsellor">Reproductive Health</option>
                                                                                <option value="Sexuality Crisis counsellor">Sexuality Crisis</option>
                                                                            </select>
                                                                            <i></i>
                                                                        </label>
                                                                    </div> -->
                                                                ...
                                                                <div class="j-footer">
                                                                    ...
                                                                    <a class="btn btn-default m-r-20" href="ptest.php">Back </a>
                                                                </div>
                                                                <!-- end /.footer -->
                                                            </form>
                                                        </div>
