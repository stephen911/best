                            ...
                            <div class="row m-0">
                                <div class="col-lg container-fluid page__container">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Renew Scholarship</li>
                                    </ol>
                                ...
                                <div class="card-body">
                                    <div class="media flex-wrap align-items-center">
                                        ...
                                        <div class="media-body"
                                             ...
                                             <strong>Renew Scholarship</strong>
                                        </div>
                                    ...
                                    <div class="list-group-item">
                                                <div class="form-group m-0"
                                                     role="group"
                                                     aria-labelledby="label-cgpa">
                                                    <div class="form-row">
                                                        <label id="label-cgpa"
                                                               for="cgpa"
                                                               class="col-md-3 col-form-label form-label">Current CGPA</label>
                                                        <div class="col-md-9">
                                                            <input id="cgpa"
                                                                   type="number"
                                    ...
                                    <div class="media flex-wrap align-items-center">
                                        <div class="media-left">
                                            <i class="material-icons text-muted-light">file_download</i>
                                        </div>
                                        <div class="media-body"
                                             style="min-width: 180px">
                                             <strong>Behavorial assessment</strong>
                                             <small>(Download, fill and upload)</small>
                                        </div>
                                        <div class="media-right mt-2 mt-xs-plus-0">
                                            <a class="btn btn-success"
                                               href="">Download</a>
                                            ...
                                            <div class="form-group row">
                                                <label for="avatar"
                                                       class="col-sm-3 col-form-label form-label">Behavorial assessment</label>
                                                <div class="col-sm-9">
                                                    <div class="media align-items-center">
                                                        <div class="media-left">
                                            ...
                                            <div class="form-group row">
                                                <label for="avatar"
                                                       class="col-sm-3 col-form-label form-label">Upload transcript</label>
                                                <div class="col-sm-9">
                                                    <div class="media align-items-center">
                                                        <div class="media-left">
                                                            <div class="icon-block rounded">
                                    ...
                                    <div data-perfect-scrollbar>
                                        <div class="page-section pt-lg-32pt">
                                            <ul class="nav page-nav__menu">
                                                <li class="nav-item">
                                                    <a href="#"
                                                       class="nav-link active">Renew Schlarship</a>
                                                </li>
                                                <!-- <li class="nav-item">
