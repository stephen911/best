            ...
            <div class="mdk-drawer-layout__content page ">
                ...
                <div class="container-fluid page__container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Masters Scholarship Application Form</li>
                    </ol>
                    <h1 class="h2">Masters Scholarship Application Form</h1>
                    ...
                    <div class="card">
                                        ...
                                        <div class="list-group list-group-fit">
                                            ...
                                            <div class="list-group-item">
                                                <div class="form-group m-0" role="group"
                                                    ...
                                                    <div class="form-row">
                                                        <label id="label-physicallyChallenged" for="email"
                                                ...
                                                <div class="media align-items-center">
                                                    <div class="media-left">
                                                        <a href="#" class="btn btn-success tab-pane-btn"
                                                            data-tab="#second">Save and continue</a>
                                                    </div>
                        ...
                        <div class="tab-pane" id="second">
                            <form action="#" class="form-horizontal">
                                                    ...
                                                    <div class="form-group m-0" role="group"
                                                        ...
                                                        <div class="form-row" id="senior1">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="custom-select"
                                                                    class="form-control custom-select">
                                                                    <option selected>BSc. Mathematics</option>
                                                                    <option value="1">BSc. physics</option>
                                                        ...
                                                        <div class="form-row" id="senior1">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="custom-select"
                                                                    ...
                                                                    <option value="1">Second Class Upper</option>
                                                                    <option value="2">Second Class Lower</option>
                                ...
                                <div class="form-group row">
                                    <label for="statement" class="col-sm-3 col-form-label form-label">Current Statement
                                        of
                                        results</label>
                                    <div class="col-sm-9">
                                        <div class="media align-items-center">
                                    ...
                                    <div class="form-group m-0" role="group" aria-labelledby="label-sop">
                                        <div class="form-row">
                                            <label id="label-sop" for="status"
                                                class="col-md-3 col-form-label form-label">Personal
                                                Statement /
                                                SOP</label>
                                            <div class="col-md-9">
